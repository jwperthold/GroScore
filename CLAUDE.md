...
- Force fields: AMBER19SB (all-atom, default), AMBER19SB with OPC3 water, GROMOS 54A7 (united-atom), or CHARMM36 (all-atom)
...
4. **Terminal Capping**:
   ...
   - **CHARMM36/GROMOS 54A7**: ACE caps via `cap_termini.py --ace-only`, COOH patches for C-termini
...
| Setting | AMBER19SB (default) | AMBER19SB OPC3 | GROMOS 54A7 | CHARMM36 |
|---------|---------------------|----------------|-------------|----------|
...
**AMBER19SB OPC3** (OPC3 water):
- Same as AMBER19SB default but with OPC3 water model (3-point, uses `spc216.gro` for solvation)
- All other settings identical to AMBER19SB default
