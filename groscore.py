...
parser.add_argument('-ff','--forcefield', type=str, default="amber19sb_opc3", choices=["gromos54a8", "charmm36", "amber19sb", "amber19sb_opc3"], help="Force field to use (default: amber19sb_opc3)")
